 ...
 */
class Version20160809144051 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE vendor_code_ruler (id INT AUTO_INCREMENT NOT NULL, brand_id INT DEFAULT NULL, ruler VARCHAR(128) NOT NULL, replacement VARCHAR(128) NOT NULL, INDEX IDX_88BD648144F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci ENGINE = InnoDB');

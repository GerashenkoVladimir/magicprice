 ...
 */
class Version20160809173246 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE brand_ruler ADD supplier_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE brand_ruler ADD CONSTRAINT FK_A56460BD2ADD6D8C FOREIGN KEY (supplier_id) REFERENCES supplier (id)');
        $this->addSql('CREATE INDEX IDX_A56460BD2ADD6D8C ON brand_ruler (supplier_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE brand_ruler DROP FOREIGN KEY FK_A56460BD2ADD6D8C');
        $this->addSql('DROP INDEX IDX_A56460BD2ADD6D8C ON brand_ruler');
        $this->addSql('ALTER TABLE brand_ruler DROP supplier_id');
        $this->addSql('ALTER TABLE original_price_list CHANGE price price DOUBLE PRECISION NOT NULL');
        $this->addSql('ALTER TABLE ready_price_list CHANGE price price DOUBLE PRECISION NOT NULL');
        $this->addSql('ALTER TABLE supplier CHANGE exchange_rate exchange_rate DOUBLE PRECISION DEFAULT NULL');
    }
